...
<Tabs>
  <Tab title="Vercel (Recommended)">
    ...
    [![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/franciscomoretti/chat.js)
    ...
    Clone the repo that Vercel created in your GitHub account and pull environment variables:
  ...
  <Tab title="Manual Setup">
    ...
    The CLI walks you through selecting your AI gateway, features, and auth providers, then generates a configured project with `chat.config.ts` ready to go.
