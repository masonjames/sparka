...
<Frame>
  <img src="/images/image-generation.gif" alt="Generating an image from a text prompt in chat" />
</Frame>
...
<Note>
  Image generation requires `BLOB_READ_WRITE_TOKEN` since generated images are
