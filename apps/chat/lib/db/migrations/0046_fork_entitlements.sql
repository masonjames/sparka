...
--> statement-breakpoint
DROP INDEX IF EXISTS "entitlement_source_external_id_idx";
--> statement-breakpoint
CREATE UNIQUE INDEX "entitlement_source_external_id_idx" ON "Entitlement" ("source", "externalId");
--> statement-breakpoint
DROP INDEX IF EXISTS "webhook_event_source_event_id_idx";
--> statement-breakpoint
CREATE UNIQUE INDEX "webhook_event_source_event_id_idx" ON "WebhookEvent" ("source", "eventId");
