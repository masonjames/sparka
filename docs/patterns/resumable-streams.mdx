...
Stream resumption is incompatible with abort functionality. Page refreshes trigger an abort signal that breaks resumption. Do not use `stop()` or abort controllers if you need resumable streams.
