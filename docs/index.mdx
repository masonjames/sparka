---
title: "Introduction"
description: "The prod-ready AI chat template"
---
...
<CardGroup cols={3}>
  <Card title="120+ Models" icon="robot" href="/core/multi-model">
  ...
  <Card title="Resumable Streams" icon="bolt" href="/cookbook/streaming/resumable-streams">
  ...
  <Card title="Syntax Highlighting" icon="code" href="/customization/theming">
    Beautiful code formatting with themes
  </Card>
  <Card title="Sharing" icon="share" href="/capabilities/sharing">
