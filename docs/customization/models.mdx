...
| `image`               | Image generation (see [Image Generation](/capabilities/image-generation)) |
...
The image model is used by the `generateImage` tool for both generation and edit modes. See [Image Generation](/capabilities/image-generation) for details.