...
<Tabs>
  ...
  <Tab title="Manual Setup">
    ...
    <AccordionGroup>
      ...
      <Accordion title="AI Gateway">
        ...
        **Option B: OpenRouter**
        ...
        See [Vercel Gateway](/core/vercel-gateway) and [OpenRouter Gateway](/core/openrouter-gateway) for details.
      </Accordion>
    </AccordionGroup>
    ...
    | `AUTH_SECRET` | [Generate one](https://generate-secret.vercel.app/32) |
    | `AI_GATEWAY_API_KEY` | From [Vercel AI Gateway](/core/vercel-gateway) (or `OPENROUTER_API_KEY` for [OpenRouter](/core/openrouter-gateway)) |
