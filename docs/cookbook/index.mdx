...
Patterns for the multi-gateway model system.
...
<CardGroup cols={2}>
  ...
  <Card title="Adding a Gateway" href="/cookbook/adding-a-gateway">
    Plug in a new AI gateway provider to the multi-gateway system
  </Card>
</CardGroup>
