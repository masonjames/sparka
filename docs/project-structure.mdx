...
| File | Purpose |
|------|---------|
| `lib/config.ts` | Central configuration (features, models, branding) |
...
See [Tool Part Pattern](/patterns/tool-part) for implementation details.
...
```
lib/config.ts          # Define features, models, branding
       ↓
