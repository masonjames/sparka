...
2. On the project home page, find the "Instructions" card
3. Click "Set instructions" to add new instructions or "Edit" to modify existing ones
4. Enter your instructions in the dialog (up to any length)
5. Click "Save instructions"

Your instructions will automatically apply to all new messages in chats within this project. The AI sees them as additional context appended to its system prompt.
...
- **Delete** the project (this removes the project but keeps your chats intact)

Click the three-dot menu next to a project name to access these options.
