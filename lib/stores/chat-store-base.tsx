...
// ): StateCreator<BaseChatStoreState2<UI_MESSAGE>, [], []> {
//   return (set, get) => {
...
//         return messages.length > 0 ? (messages.at(-1)?.id ?? null) : null;
//       },
...
export type BaseSC<UM extends UIMessage> = StateCreator<StoreState<UM>, [], []>;
