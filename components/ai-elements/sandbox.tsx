...
export const Sandbox = ({ className, ...props }: SandboxRootProps) => (
  <Collapsible
    defaultOpen
    className={cn(
      "not-prose mb-4 w-full rounded-md border group",
      className
    )}
    {...props}
  />
...
export const SandboxTabsTrigger = ({
  ...
  <TabsTrigger
    className={cn(
      "rounded-none border-0 border-b-2 border-transparent px-4 py-2 font-medium text-sm transition-colors data-[state=active]:border-primary data-[state=active]:bg-transparent data-[state=active]:text-foreground data-[state=active]:shadow-none text-muted-foreground",
      className
    )}
    {...props}
  />
...
export const SandboxCode = ({
  ...
  <TabsContent value="code" className={cn("mt-0 text-sm", className)}>
...
export const SandboxOutput = ({ output, className }: SandboxOutputProps) => (
  <TabsContent value="output" className={cn("mt-0 text-sm", className)}>
